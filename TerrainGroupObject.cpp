...
void TerrainGroupObject::BuildTerrainData(bool bLand, const GPSTerrainData& terrainData, std::vector<unsigned int>& indexList)
{
	std::map<unsigned int, unsigned int> indexMappingList;
